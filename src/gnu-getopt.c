 ...
 * and getopt_long_only implementation. Code after the makup <GNU-CODE>
 * is unmodified. The codde added here permits to use the Sheme IO function
 * instead of the  standard C fprintf.
 *
 * We could have used the fact that we can set `opterr` to 1  to avoid any print
 * from standard getopt_long (which is POSIX), but the error messages would have been
 * less precise.
 */
...
/* Redefine fprintf to our function for later uses in this file */
#define fprintf getopt_fprintf
...
extern struct option* option;   // KLUDGE: this avoids a warning in the next line.
...
/* This version of `getopt' appears to the caller like standard Unix `getopt'
   ...
   Then the behavior is complmetely standard.
