...
"eof-object" " "
"#eof" " "
"((define-parameter . define-parameter) (compiler:time-display . compiler:time-display) (compiler:gen-line-number . compiler:gen-line-number) (compiler:warn-use-undefined . compiler:warn-use-undefined) (compiler:warn-use-undefined-postpone . compiler:warn-use-undefined-postpone) (compiler:show-assembly-code . compiler:show-assembly-code) (compiler:keep-formals . compiler:keep-formals) (compiler:keep-source . compiler:keep-source) (compiler:inline-common-functions . compiler:inline-common-functions) (compiler:unroll-iterations . compiler:unroll-iterations) (compiler:peephole-optimizer . compiler:peephole-optimizer) (compiler:source-rewrite . compiler:source-rewrite))" " "
...
"printf" " "
"declare-new-error" " "
"(lambda (name) (let ((cond-name (string->symbol (format \"&~a\" name))) (predicate (string->symbol (format \"&~a?\" name))) (args (gensym))) `(begin (define-condition-type ,cond-name &error-message ,predicate) (define (,name unquote args) (if (and (not (null? ,args)) (symbol? (car ,args))) (apply signal-error ,cond-name ,args) (apply signal-error ,cond-name ',name ,args))))))" " "
"\"&~a\"" " "
"\"&~a?\"" " "
...
"require-extension" " "
"(lambda args (%find-macro-clause 'require-extension args '(require-extension srfi) '(((_ \"internal\" (srfi id ...)) (begin (require-feature id) ...)) ((_ \"internal\" (x ...)) (import (x ...))) ((_ \"internal\" id) (cond-expand (id #void) (else (error \"cannot require extension named '~s'\" 'id)))) ((_ clause ...) (begin (require-extension \"internal\" clause) ...))) '...))" " "
...
"fx-least" " "
"assume" " "
"(lambda (expr . args) (if (positive? (stklos-debug-level)) (let* ((efile (and (%epair? expr) (%epair-file expr))) (eline (and (%epair? expr) (%epair-line expr))) (fmt (string-append (if efile (format \"in ~A:~A, \" efile eline) \"\") \"invalid assumption:\"))) `(or ,expr (error ,fmt ',expr ,@args))) #void))" " "
"\"in ~A:~A, \"" " "
"\"\"" " "
"\"invalid assumption:\"" " "
"\"srfi-\"" " "
