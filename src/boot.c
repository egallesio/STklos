...
"((SCHEME))" " "
"((eval . eval) (disassemble . disassemble) (disassemble-expr . disassemble-expr) (%compiler-set-flags . %compiler-set-flags) (%grab-file-information . %grab-file-information) (%compiler-new-label . %compiler-new-label) (%macro-expand . %macro-expand) (compiler-current-module . compiler-current-module) (when-compile . when-compile) (when-load-and-compile . when-load-and-compile) (%syntax-error . %syntax-error) (%compile-time-define . %compile-time-define))" " "
"*compiler-port*" " "
"(+ * gcd lcm)" " "
