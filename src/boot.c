...
"dolist" " "
"(lambda (binding . body) (unless (and (pair? binding) (<= 2 (length binding) 3) (symbol? (car binding))) (error 'dolist \"bond must be symbol \" binding)) (when (null? body) (error 'dolist \"empty body\")) `(for-each (lambda (,(car binding)) ,@body) ,(cadr binding)))" " "
"\"bond must be symbol \"" " "
"\"empty body\"" " "
"\"call/ec\"" " "
"call/ec" " "
