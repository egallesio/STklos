...
"define-read-directive" " "
"(lambda (name . body) (let ((port (gensym)) (str (gensym))) `(begin (when-load-and-compile (%add-read-directive ',name (lambda (,port ,str) (let ((current-port (lambda () ,port)) (current-directive (lambda () (format \"#~a\" ,str)))) ,@body)))))))" " "
"%add-read-directive" " "
"current-port" " "
"current-directive" " "
"\"#~a\"" " "
