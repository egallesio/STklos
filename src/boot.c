...
"*compiler-port*" " "
"add-entry-to-inline-table" " "
"(lambda (*table* name) (if (pair? name) `(set! ,*table* (cons (cons ',(car name) ,(cadr name)) ,*table*)) `(set! ,*table* (cons (cons ',name ,name) ,*table*))))" " "
"cons" " "
"add-list-to-inline-table" " "
"(lambda (*table* . names) (when (null? names) (error 'add-list-to-inline-table \"need at least two arguments, onle one given.\")) (cons 'begin (map (lambda (n) `(add-entry-to-inline-table ,*table* ,n)) names)))" " "
"\"need at least two arguments, onle one given.\"" " "
"make-inline-table" " "
"(lambda entries `(list ,@(map (lambda (x) (if (pair? x) `(cons ',(car x) ,(cadr x)) `(cons ',x ,x))) entries)))" " "
"list" " "
"+" " "
"*" " "
"gcd" " "
